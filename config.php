...
$THEME->name = 'essential_gourmet';

// The only thing you need to change in this file when copying it to
// create a new theme is the name above. You also need to change the name
// in version.php and lang/en/theme_essential_gourmet.php as well.

$THEME->doctype = 'html5';
$THEME->yuicssmodules = array();
$THEME->parents = array('bootstrapbase');
$THEME->sheets = array('flexslider', 'categories', 'font-awesome.min', 'essential_gourmet');
...
$THEME->csspostprocess = 'theme_essential_gourmet_process_css';
