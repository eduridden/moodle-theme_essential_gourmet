 ...
 */
function theme_essential_gourmet_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_essential_gourmet_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_essential_gourmet_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @return string
 */
function essential_gourmet_set_pagewidth($css, $pagewidth) {
 ...
 * @return string
 */
function essential_gourmet_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/essential_gourmet/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/essential_gourmet/style/editicons.css'; //MDL-36065
	}
 ...
 * @return string
 */
function essential_gourmet_performance_output($param) {
 ...
 */
function essential_gourmet_set_customcss($css, $customcss) {
...
function theme_essential_gourmet_process_css($css, $theme) {
    ...
    $css = essential_gourmet_set_pagewidth($css,$pagewidth);
    ...
    $css = theme_essential_gourmet_set_headingfont($css, $headingfont);
    $css = theme_essential_gourmet_set_bodyfont($css, $bodyfont);
    $css = theme_essential_gourmet_set_bodysize($css, $bodysize);
    $css = theme_essential_gourmet_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_essential_gourmet_set_themecolor($css, $themecolor);
    ...
    $css = theme_essential_gourmet_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_essential_gourmet_set_footercolor($css, $footercolor);
    ...
    $css = theme_essential_gourmet_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_essential_gourmet_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_essential_gourmet_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_essential_gourmet_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_essential_gourmet_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_essential_gourmet_set_slideheadercolor($css, $slideheadercolor);
    ...
    $css = theme_essential_gourmet_set_slidecolor($css, $slidecolor);
    ...
    $css = theme_essential_gourmet_set_slidebuttoncolor($css, $slidebuttoncolor);
    ...
    foreach (range(1, 3) as $alternativethemenumber) {
        ...
        $css = theme_essential_gourmet_set_alternativecolor($css, 'color' . $alternativethemenumber, $theme->settings->{'alternativethemecolor' . $alternativethemenumber}, $default);
        $css = theme_essential_gourmet_set_alternativecolor($css, 'hovercolor' . $alternativethemenumber, $theme->settings->{'alternativethemehovercolor' . $alternativethemenumber}, $defaulthover);
    }
    ...
    $css = theme_essential_gourmet_set_navbarsep($css, $navbarsep);
    ...
    $css = essential_gourmet_set_editicons($css, $editicons);
    ...
    $css = essential_gourmet_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_essential_gourmet_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_essential_gourmet_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_essential_gourmet_set_defaultcategoryicon($css, $defaultcategoryicon);
    ...
    foreach (range(1, 20) as $categorynumber) {
        ...
        $css = theme_essential_gourmet_set_categoryicon($css, $categoryicon, $categorynumber);
    }
    ...
    $css = theme_essential_gourmet_set_slideimage($css, $slideimage, $setting);
    ...
    $css = theme_essential_gourmet_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_essential_gourmet_set_marketingimage($css, $marketingimage, $setting);
    ...
    $css = theme_essential_gourmet_set_fontwww($css);
    return $css;
}
 
function theme_essential_gourmet_set_headingfont($css, $headingfont) {
...
function theme_essential_gourmet_set_bodyfont($css, $bodyfont) {
...
function theme_essential_gourmet_set_bodysize($css, $bodysize) {
...
function theme_essential_gourmet_set_bodyweight($css, $bodyweight) {
...
function theme_essential_gourmet_set_themecolor($css, $themecolor) {
...
function theme_essential_gourmet_set_themehovercolor($css, $themehovercolor) {
...
function theme_essential_gourmet_set_alternativecolor($css, $type, $customcolor, $defaultcolor) {
...
function theme_essential_gourmet_set_footercolor($css, $footercolor) {
...
function theme_essential_gourmet_set_footertextcolor($css, $footertextcolor) {
...
function theme_essential_gourmet_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_essential_gourmet_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_essential_gourmet_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_essential_gourmet_set_slideheadercolor($css, $slideheadercolor) {
...
function theme_essential_gourmet_set_slidecolor($css, $slidecolor) {
...
function theme_essential_gourmet_set_slidebuttoncolor($css, $slidebuttoncolor) {
...
function theme_essential_gourmet_set_footersepcolor($css, $footersepcolor) {
...
function theme_essential_gourmet_set_navbarsep($css, $navbarsep) {
...
function theme_essential_gourmet_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_essential_gourmet_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_essential_gourmet_set_marketingheight($css, $marketingheight) {
...
function theme_essential_gourmet_set_marketingimage($css, $marketingimage, $setting) {
    $tag = '[[setting:'.$setting.']]';
...
function theme_essential_gourmet_set_defaultcategoryicon($css, $defaultcategoryicon) {
...
function theme_essential_gourmet_set_categoryicon($css, $categoryicon, $categorynumber) {
...
function theme_essential_gourmet_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('custom', 'theme_essential_gourmet'); 
    $page->requires->jquery_plugin('alert', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('carousel', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('collapse', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('modal', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('scrollspy', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('tab', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('tooltip', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('transition', 'theme_essential_gourmet');
    $page->requires->jquery_plugin('modernizr', 'theme_essential_gourmet');  
    $page->requires->jquery_plugin('flexslider', 'theme_essential_gourmet');
}