...
/* Core */
$string['configtitle'] = 'essential_gourmet';
$string['pluginname'] = 'essential_gourmet';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>essential_gourmet</h2>
<p><img class=img-polaroid src="essential_gourmet/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About essential_gourmet</h3>
<p>essential_gourmet is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
